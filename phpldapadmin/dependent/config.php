...
$servers->setValue('server','name','Shannon Server');
...
$servers->setValue('server','base',array('dc=shannon,dc=com'));
...
/* The DN of the user for phpLDAPadmin to bind with. For anonymous binds or
   ...
   binds. */
$servers->setValue('login','bind_id','cn=admin,dc=shannon,dc=com');
